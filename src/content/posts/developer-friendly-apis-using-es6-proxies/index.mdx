...
The same "intercept the behaviour in one place" idea isn't limited to objects — [Axios interceptors](/blog/4-ways-to-use-axios-interceptors) apply it to HTTP, letting you hook into every request and response.
