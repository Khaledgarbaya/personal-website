...
description: "Gatsby vs create-react-app: both cut config, but Gatsby adds built-in performance, static rendering with no server, and a rich plugin ecosystem."
