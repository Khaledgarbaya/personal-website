...
/** The type of the `value` property of a ComponentParameter of type link when its value links to a project map node */
type ProjectMapLinkComponentParameterValue = {
    type: 'projectMapNode';
    projectMapId: string;
    nodeId: string;
    path: string;
...
/** The type of the `value` property of a ComponentParameter of type link */
type LinkComponentParameterValue = ProjectMapLinkComponentParameterValue | {
